...
export const ProjectName: FC = () => {
  return (
    <MultiContainer className={styles.projectBlock}>
      ...
      <img src="https://elements-resized.envatousercontent.com/elements-video-cover-images/9f39a1d3-c1df-4c20-80c3-1f32748bd111/video_preview/video_preview_0000.jpg?w=500&cf_fit=cover&q=85&format=auto&s=99e57aaec4af6cdfbeb981f134c2db4bd8337557836c1e70dd4bbe5034d392cc" alt="" />
    </MultiContainer>
  );
};
